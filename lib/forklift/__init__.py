...
class Forklift(object):
  ...
  @classmethod
  def normalize_and_sanitize(self, dataframe, with_spark_schema, remappings_file_path, cast_processor):
    ...
    print("Step 4: Return the normalized and sanitized dataframe")
