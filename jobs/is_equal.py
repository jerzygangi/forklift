...
parser.add_argument("one", type=string, required=True, help="One DataFrame to compare")
parser.add_argument("another", type=string, required=True, help="Another DataFrame compare")
